...
export interface UpdatePreSaleRequest extends Partial<Omit<CreatePreSaleRequest, 'items'>> {
    items?: CreatePreSaleItemRequest[];
}
...
export interface ProductFormData extends Omit<CreateProductRequest, 'purchasePrice' | 'salePrice'> {
    purchasePrice: number | string; // Allow number input in forms
    salePrice: number | string;
}

export interface PreSaleFormData extends Omit<CreatePreSaleRequest, 'items' | 'discount' | 'discountPercentage'> {
    discount?: number | string;
    discountPercentage?: number | string;
    items: Array<Omit<CreatePreSaleItemRequest, 'quantity' | 'unitPrice' | 'discount' | 'discountPercentage'> & {

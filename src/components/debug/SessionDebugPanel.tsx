...
const SessionDebugPanel: React.FC<SessionDebugPanelProps> = ({ isVisible = false }) => {
        ...
        <div className="fixed bottom-4 right-4 z-50 bg-white border border-gray-300 rounded-lg shadow-xl p-4 max-w-md">
            ...
            <div className="space-y-2 text-sm">
                <div className="grid grid-cols-2 gap-2">
                    ...
                    <div className={debugInfo.hasLastActivity ? 'text-green-600' : 'text-red-600'}>
                        {debugInfo.hasLastActivity ? '✓' : '✗'}
                    </div>

                    <div>Activity Valid:</div>
                    <div className={debugInfo.isActivityValid ? 'text-green-600' : 'text-red-600'}>

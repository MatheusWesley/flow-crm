...
describe('SimplifiedPage', () => {
	...
	it('renders default development message', () => {
		render(<SimplifiedPage title="Test Page" />);
		expect(screen.getByText('Página em desenvolvimento...')).toBeInTheDocument();
	});

	it('renders custom message when provided', () => {
		render(<SimplifiedPage title="Test Page" message="de teste em construção..." />);
		expect(screen.getByText('Página de teste em construção...')).toBeInTheDocument();
	});

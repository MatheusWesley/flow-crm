        ...
        <div className="min-h-screen bg-gray-50 flex items-center justify-center p-4">
            <div className="max-w-md w-full bg-white rounded-lg shadow-lg p-6">
                ...
                <p className="text-gray-600 text-center mb-6">
                    Para fins de teste, você pode habilitar temporariamente o acesso aos relatórios.
                </p>
                ...
                <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-4 mb-6">
                    ...
                    <p className="text-sm text-yellow-700">
                        Esta é uma solução temporária apenas para testes. Em produção,
                        as permissões devem ser gerenciadas através do sistema de usuários.
                    </p>
                </div>

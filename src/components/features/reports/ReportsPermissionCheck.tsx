            ...
            <div className="max-w-md mx-auto bg-white rounded-lg shadow-lg p-6">
                ...
                <div className="bg-gray-50 rounded-lg p-4 mb-6">
                    <div className="flex items-center mb-2">
                        ...
                        <span className="text-sm font-medium text-gray-700">Usuário Atual</span>
                    </div>
                ...
                <div className="bg-gray-50 rounded-lg p-4 mb-6">
                    <div className="flex items-center mb-2">
                        ...
                        <span className="text-sm font-medium text-gray-700">Status das Permissões</span>
                    </div>
                    <div className="ml-6 space-y-1">
                        ...
                        <div className="flex items-center justify-between text-sm">
                            ...
                            <span className={permissions?.modules.products ? "text-green-600" : "text-red-600"}>
                                {permissions?.modules.products ? "✅ Permitido" : "❌ Negado"}
                            </span>
                        </div>
                        <div className="flex items-center justify-between text-sm">
                            <span className="text-gray-600">Clientes:</span>
                            <span className={permissions?.modules.customers ? "text-green-600" : "text-red-600"}>
                ...
                <div className="bg-blue-50 rounded-lg p-4 mb-6">
                    <div className="flex items-center mb-2">
                        ...
                        <span className="text-sm font-medium text-blue-700">Como Resolver</span>
                    </div>
                    <div className="ml-6 text-sm text-blue-600 space-y-2">
                        {isAdmin ? (
                            <p>
                                Como administrador, você deveria ter acesso automático.
                                Verifique se suas permissões estão configuradas corretamente no banco de dados.
                            </p>
                        ) : (
                            <>
                                <p>Para acessar os relatórios, você precisa que um administrador:</p>

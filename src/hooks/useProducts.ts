    ...
    const fetchProducts = useCallback(async (filters: ProductFilters = {}) => {
        try {
            ...
            const convertedProducts: Product[] = apiProducts.map((apiProduct) => ({
                ...
                purchasePrice: typeof apiProduct.purchasePrice === 'string' ? parseFloat(apiProduct.purchasePrice) : apiProduct.purchasePrice,
                salePrice: typeof apiProduct.salePrice === 'string' ? parseFloat(apiProduct.salePrice) : apiProduct.salePrice,

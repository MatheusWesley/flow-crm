...
export const useSession = (): UseSession => {
    ...
    const updateSessionInfo = useCallback(() => {
        ...
        const timeRemaining = Math.max(0, sessionInfo.sessionTimeout - timeSinceActivity);
        const showWarning = timeRemaining <= sessionInfo.warningThreshold && timeRemaining > 0;

...
export const useDashboard = (): UseDashboardReturn => {
    ...
    const refreshSales = useCallback(async () => {
        try {
            ...
            const errorMessage = error instanceof Error ? error.message : 'Erro ao carregar dados de vendas';
    ...
    const refreshActivities = useCallback(async () => {
        try {
            ...
            const errorMessage = error instanceof Error ? error.message : 'Erro ao carregar atividades recentes';
    ...
    const refreshAlerts = useCallback(async () => {
        try {
            ...
            const errorMessage = error instanceof Error ? error.message : 'Erro ao carregar alertas de inventário';

...
export class PresaleService {
     ...
     */
    async getAll(params?: PreSaleQueryParams): Promise<PaginatedResponse<PreSale>> {
        try {
            ...
            if (apiResponse && apiResponse.success && Array.isArray(apiResponse.data)) {
                ...
                console.error('PresaleService - Invalid API response structure:', apiResponse);
            ...
            return {
                data: [],
                success: false,
                message: error instanceof Error ? error.message : 'Failed to fetch presales',
    ...
    async getById(id: string): Promise<ApiResponse<PreSale>> {
        try {
            ...
            return {
                success: false,
                data: null as any,
                message: error instanceof Error ? error.message : 'Failed to fetch presale',
                timestamp: new Date().toISOString()
            };
        }
    }
     ...
     */
    async create(presaleData: CreatePreSaleRequest): Promise<ApiResponse<PreSale>> {
        try {
            ...
            return {
                success: false,
                data: null as any,
                message: error instanceof Error ? error.message : 'Failed to create presale',
                timestamp: new Date().toISOString()
            };
        }
    }
     ...
     */
    async update(id: string, presaleData: UpdatePreSaleRequest): Promise<ApiResponse<PreSale>> {
        try {
            const data = await httpClient.put<PreSale>(`${this.baseUrl}/${id}`, presaleData);
            return {
                success: true,
                data,
            ...
            return {
                success: false,
                data: null as any,
                message: error instanceof Error ? error.message : 'Failed to update presale',
                timestamp: new Date().toISOString()
            };
        }
    }
    ...
    async delete(id: string): Promise<ApiResponse<void>> {
        try {
            ...
            return {
                success: false,
                data: undefined as any,
                message: error instanceof Error ? error.message : 'Failed to delete presale',
                timestamp: new Date().toISOString()
            };
        }
    }
    ...
    async updateStatus(
        ...
        try {
            const data = await httpClient.patch<PreSale>(`${this.baseUrl}/${id}/status`, { status });
            return {
                success: true,
                data,
            ...
            return {
                success: false,
                data: null as any,
                message: error instanceof Error ? error.message : 'Failed to update presale status',
                timestamp: new Date().toISOString()
            };
        }
    }
    ...
    async convertToSale(id: string): Promise<ApiResponse<PreSale>> {
        try {
            const data = await httpClient.post<PreSale>(`${this.baseUrl}/${id}/convert`);
            return {
                success: true,
                data,
            ...
            return {
                success: false,
                data: null as any,
                message: error instanceof Error ? error.message : 'Failed to convert presale to sale',
                timestamp: new Date().toISOString()
            };
        }
    }
    ...
    async calculateTotals(
        ...
        return httpClient.post<{ total: string; subtotal: string; discountAmount: string }>(
     ...
     */
    validateStatusTransition(currentStatus: PreSale['status'], newStatus: PreSale['status']): boolean {
    ...
    validatePresaleData(data: CreatePreSaleRequest | UpdatePreSaleRequest): {
        ...
        if (data.discountType === 'percentage' && data.discount && Number(data.discount) > 100) {
